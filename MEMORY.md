...
- 2026-06-13: Timed bonus fruit state lives in `src/js/bonus-fruit.js`, is coordinated from `game.js`, and uses `BONUS_FRUIT_*` constants in `src/js/constants.js` for score, spawn delay, interval, duration, and tile.
