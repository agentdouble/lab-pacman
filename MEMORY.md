...
- 2026-06-20: Character selection lives in `src/js/characters.js` and `src/js/character-selector.js`; selected profiles affect Pac-Man color/accent, starting lives, speed, score multiplier, and power pellet duration, and changing the selected character starts a fresh run.
