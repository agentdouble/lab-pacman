...
- 2026-06-13: Pac-Man color selection is centralized in `PACMAN_COLORS` (`src/js/constants.js`), applied to the `Pacman` entity, rendered from `renderer.js`, and preserved across in-game restarts.
